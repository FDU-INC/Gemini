...
class FastRouter(Router):
    ...
    def set_all(self, neighbour_matrix, distance):
        ...
        self.distance = distance
        self.gs_sat_divide()
    ## 根据 gs_no_list, 区分地面站和卫星，构造地面邻接矩阵、星地邻接矩阵
    def gs_sat_divide(self):
        # 判断gs_no_list 是否是一个差为1的递增等差数列，最后一项为节点数量
        ...
        # print("gs_neighbour_matrix:", self.gs_neighbour_matrix)
        # print("sat_neighbour_matrix:", self.sat_neighbour_matrix)
        # print("gs_sat_distance:", self.gs_sat_distance)
        # print("sat_distance:", self.sat_distance)
